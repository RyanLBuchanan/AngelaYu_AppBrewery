...
print(f"Each person should pay: ${round(float(input('What was the total bill? '))
* (1 + int(input('What percentage tip would you like to give? '))/100)
/ int(input('How many people to split the bill? ')), 2)}")
