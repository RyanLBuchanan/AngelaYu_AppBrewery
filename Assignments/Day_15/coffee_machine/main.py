...
while not action_completed:
    ...
    # print(MENU[user_input]['ingredients']['water'])

    # Process the user input or perform actions here.
    ...
    if user_input == "espresso":
        order_drink("espresso")
    elif user_input == "latte":
        order_drink("latte")
    elif user_input == "cappuccino":
        order_drink("cappuccino")
